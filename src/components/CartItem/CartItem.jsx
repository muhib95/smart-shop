...
const CartItem = ({product,removeItem}) => {
  const {picture,name,quantity,price }=product;
  return (
				...
				<div className="flex flex-col justify-between w-full pb-4">
					<div className="flex justify-between w-full pb-2 space-x-2">
						...
						<div className="text-right">
							<p className="text-lg font-semibold">price:{price*quantity}</p>
							<p className="text-sm line-through text-gray-600"></p>
						</div>
					</div>
					<div className="flex text-sm divide-x">
						<button onClick={()=>removeItem(product)} type="button" className="flex items-center px-2 py-1 pl-0 space-x-1">
